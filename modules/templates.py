...
TEMPLATES = {
    # item 1 example.cpp
    'example.cpp' : f"""#include <iostream>
...
""",
    ...
    # item 2 main.cpp
    'main.cpp' : f"""#include "../hdr/example.hpp"
#include <iostream>
...
""",
    ...
    # item 3 example.hpp
    'example.hpp' : f"""#ifndef EXAMPLE_HPP
#define EXAMPLE_HPP
...
""",
    ...
    # item 4 Makefile
    'Makefile' : f"""RELEASE=$(CXX) $(WARNINGS) $(OUT_FLG)
